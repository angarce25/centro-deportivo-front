...
function FirstTeam() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="border-b-8 border-yellow-d my-8"></div> {/* Incremento del margen */}
      <div className="max-w-6xl mx-auto p-6 flex">
        ...
        <div className="w-1/5 ml-6"> {/* Incremento del margen */}
          <h2 className="text-3xl text-yellow-d font-bold mb-4">Categoría:</h2>
          <p className="text-gray-700 text-lg">TERCERA DE AFICIONADOS</p>
          <h2 className="text-3xl text-yellow-d font-bold mt-8 mb-4">Goleadores:</h2> {/* Incremento del margen */}
      ...
      <div className="max-w-6xl mx-auto mb-8 p-4 flex">
        <div className="w-4/6 pr-8"> {/* Incremento del margen */}
          <img src={PrimeraAficionados} alt="Primera Aficionados" className="object-cover w-full h-auto" />
          <h2 className="text-3xl text-yellow-d font-bold mb-6 mt-6">Más Información:</h2> {/* Incremento del margen */}
          <p className="text-gray-700 text-lg mb-4"> {/* Incremento del margen */}
            Si quieres saber más sobre las clasificaciones, por favor visita el siguiente enlace:
          </p>
          <a href="https://www.rffm.es/competicion/calendario?temporada=19&tipojuego=1&competicion=17145393&grupo=17145396" className="text-blue-500 underline">
            Ver Clasificaciones
          </a>
        </div>
        <div className="w-2/6">
          <h2 className="text-3xl text-yellow-d font-bold mb-4">Jugadores:</h2>
          <ul className="list-inside text-gray-700 text-lg">
            {jugadores.map((jugador, index) => (
              <li key={index} className="mb-2">{jugador}</li> 
            ))}
          </ul>
        </div>
      </div>
