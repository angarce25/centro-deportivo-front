...
const AssignTeamModal = ({ isOpen, onClose, player, onSave }) => {
  ...
  const handleSave = async (e) => {
    ...
    const newStatus = selectedTeam && (selectedTeam.name === 'Infantil A' || selectedTeam.name === 'Infantil B') ? true : player.status;
    // Guardar los cambios, incluyendo el nuevo estado
    await onSave(player._id, teamId, newStatus);
  };
